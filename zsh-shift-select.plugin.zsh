...
function {
	...
	for	kcap   seq          seq_mac    widget (             # key name
		...
		x      '^[[1;4A'    '^[[1;4A'  beginning-of-buffer  # Shift + Alt + UpArrow
		x      '^[[1;4B'    '^[[1;4B'  end-of-buffer        # Shift + Alt + DownArrow
		x      '^[[1;4H'    '^[[1;4H'  beginning-of-buffer  # Shift + Alt + Home
		x      '^[[1;4F'    '^[[1;4F'  end-of-buffer        # Shift + Alt + End
	    x      '^[X'    	x  		   x-cut		        # Shift + Alt + X
	    x      '^[C'    	x  		   x-yank		        # Shift + Alt + C
		x      '^[V'    	x  		   x-paste		        # Shift + Alt + V
	); do
